...
export const StrToAbiType: { [key: string]: ABIDataTypes } = {
    // ABI-style type names
    address: ABIDataTypes.ADDRESS,
    extended_address: ABIDataTypes.EXTENDED_ADDRESS,
    ...
    schnorr_signature: ABIDataTypes.SCHNORR_SIGNATURE,
    'tuple(address,uint256)[]': ABIDataTypes.ADDRESS_UINT256_TUPLE,
    'tuple(extended_address,uint256)[]': ABIDataTypes.EXTENDED_ADDRESS_UINT256_TUPLE,
    'address[]': ABIDataTypes.ARRAY_OF_ADDRESSES,
    'extended_address[]': ABIDataTypes.ARRAY_OF_EXTENDED_ADDRESSES,
